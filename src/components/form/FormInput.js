...
import {getValidationErrorKey} from "../../helpers/getValidationErrorKey";
...
function FormInput(props)
{
    ...
    return (
        <>
            ...
            />
            <span id={errorSpanId} className="errors-text">{translatedErrorMessage === "validation.messages."? '':translatedErrorMessage}</span>
        </>
    )
}
